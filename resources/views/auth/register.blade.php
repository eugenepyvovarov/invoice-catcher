                        ...
                        <div class="form-group row mb-2">
                            ...
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" name="agreement" type="checkbox" value="1" id="flexCheckChecked" required>
                                    <label class="form-check-label" for="flexCheckChecked">
                                        <a target="_blank" href="{{ route('agreement') }}">Agreement / power of attorney</a>
                                    </label>
                                    @error('agreement')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
